...
local DEFAULTS = {
    Square = {
        ...
        FillColor=false, FillTransparency=0, Gradient=nil,
        GradientTransparency=nil, GradientRotation=0,
    },
    Text = {
        Visible=false, ZIndex=1, Color=Color3.new(1,1,1), Transparency=0,
...
local NILABLE_KEYS = { Gradient = true, GradientTransparency = true }
