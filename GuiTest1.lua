        ...
        local tab = {
            ...
            CreateGroupbox = function(self, name, side)
                ...
                local groupbox = {
                    ...
                    AddColorPicker = function(self, id, options)
                        options = options or {}
                        ...
                        ColorPickerFrame.Name = id .. "ColorPicker"
                        ColorPickerFrame.Parent = GroupboxContent
                        ColorPickerFrame.BackgroundTransparency = 1
                        ColorPickerFrame.Size = UDim2.new(1, 0, 0, 22)
                        ...
                        ColorPickerText.Size = UDim2.new(1, -28, 1, 0)
                        ColorPickerText.Font = Enum.Font.Gotham
                        ColorPickerText.Text = options.Text or id
                        ColorPickerText.TextColor3 = options.TextColor
                        ColorPickerText.TextSize = 12
                        ColorPickerText.TextXAlignment = Enum.TextXAlignment.Left
                        ColorPickerText.TextTruncate = Enum.TextTruncate.AtEnd

                        ColorIcon.Name = "ColorIcon"
                        ColorIcon.Parent = ColorPickerFrame
                        ColorIcon.BackgroundColor3 = options.Default or options.DefaultColor or Window.DefaultColor
                        ...
                        -- Color picker logic
                        local currentColor = options.Default or options.DefaultColor or Color3.new(1, 1, 1)
                    ...
                    AddToggle = function(self, id, options)
                        ...
                        if options.HasColorPicker then
                            ...
                            ColorIcon.BackgroundColor3 = options.Default or Window.DefaultColor
                            ColorIcon.AnchorPoint = Vector2.new(1, 0.5)
                            ColorIcon.Position = UDim2.new(1, 0, 0.5, 0)
                            ColorIcon.Size = UDim2.new(0, 18, 0, 18)
                            ColorIcon.Text = ""
                        ...
                        -- Color picker implementation (FIXED - line 348 area)
                        ...
                        if options.HasColorPicker then
                            ...
                            -- Create main color picker window - MUCH SMALLER
                            local colorPickerWindow = Instance.new("Frame")
                            colorPickerWindow.Name = "ColorPickerWindow"
                            colorPickerWindow.Parent = colorPickerScreenGui
                            colorPickerWindow.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
                            ...
                            -- Create overlay frame for gradients
                            local svOverlay = Instance.new("Frame")
                            svOverlay.Name = "SVOverlay"
                            svOverlay.Parent = saturationValueBox
                            svOverlay.BackgroundTransparency = 1
