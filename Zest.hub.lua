...
local espLoader = loadstring(game:HttpGet('https://raw.githubusercontent.com/Nafe03/project-delta/main/EspEXE.lua'))
...
ESP = espLoader({
    espDistance = 1000,
    espColor = Color3.fromRGB(128, 187, 219),
    DefaultColor = Color3.fromRGB(0, 255, 255),
